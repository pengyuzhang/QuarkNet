...
class rfid_command_gate_cc_sptr(object):
    ...
    def set_tag_q_out(self, *args, **kwargs):
        """set_tag_q_out(self, gr_msg_queue_sptr msgq)"""
        return _rfid_swig.rfid_command_gate_cc_sptr_set_tag_q_out(self, *args, **kwargs)
...
class rfid_reader_f_sptr(object):
    ...
    def get_tag_q(self):
        """get_tag_q(self) -> gr_msg_queue_sptr"""
        return _rfid_swig.rfid_reader_f_sptr_get_tag_q(self)

    def check_reader_state(self):
        """check_reader_state(self) -> bool"""
        return _rfid_swig.rfid_reader_f_sptr_check_reader_state(self)
